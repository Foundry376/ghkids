...
export const SELECT_RULE_ID = "SELECT_RULE_ID";
...
export const UPSERT_ACTORS = "UPSERT_ACTORS";
export const DELETE_ACTORS = "DELETE_ACTORS";
...
export const SET_CHARACTER_Z_ORDER = "SET_CHARACTER_Z_ORDER";
export const SET_CHARACTER_VARIABLE_POSITIONS = "SET_CHARACTER_VARIABLE_POSITIONS";
...
export const REWIND_ALL_GAME_STATE = "REWIND_ALL_GAME_STATE";
...
export const SETUP_CHECK_RECORDING_FOR_ACTOR = "SETUP_CHECK_RECORDING_FOR_ACTOR";
...
export const UPSERT_STAGE_VARIABLE = "UPSERT_STAGE_VARIABLE";
export const DELETE_STAGE_VARIABLE = "DELETE_STAGE_VARIABLE";
export const SET_STAGE_VARIABLE_VALUE = "SET_STAGE_VARIABLE_VALUE";
export const SET_GLOBAL_POSITIONS = "SET_GLOBAL_POSITIONS";
export const SET_STAGE_VARIABLE_POSITIONS = "SET_STAGE_VARIABLE_POSITIONS";
